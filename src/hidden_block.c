...
//D_801054F8
s16 CurBoardHiddenBlockBlacklistCount = 0x08;
...
s16 ChillyWatersHiddenBlockBlacklist[] = {
    0x0036, 0x002F, 0x005E, 0x0012, 0x0051, 0x0060, 0x004D, 0x0029,
};

s16 DeepBlooperSeaHiddenBlockBlacklist[] = {
    0x001E, 0x0028, 0x0015, 0x0007, 0x0041, 0x005C, 0x004C, 0x0056
};

s16 SpinyDesertHiddenBlockBlacklist[] = {
    0x0004, 0x005A, 0x0014, 0x001E, 0x0028, 0x004F, 0x0002, 0x003E
};

s16 WoodyWoodsHiddenBlockBlacklist[] = {
    0x004B, 0x0046, 0x0016, 0x0025, 0x0035, 0x0030, 0x0009, 0x0003
};

s16 CreepyCavernHiddenBlockBlacklist[] = {
    0x000B, 0x001F, 0x0028, 0x0013, 0x0048, 0x005C, 0x0056, 0x0031
};

s16 WaluigisIslandHiddenBlockBlacklist[] = {
    0x0016, 0x0009, 0x0013, 0x0027, 0x002F, 0x004E, 0x0045, 0x0055,
    0x0029, 0x002A, 0x002B, 0x002D, 0x002E, 0x0024, 0x0030, 0x0031,
    0x0032, 0x0020, 0x0023, 0x0025, 0x0026, 0x0028, 0x0033
};

s16* HiddenBlockSpacesBlacklist[] = {
    ChillyWatersHiddenBlockBlacklist,
    DeepBlooperSeaHiddenBlockBlacklist,
    SpinyDesertHiddenBlockBlacklist,
    WoodyWoodsHiddenBlockBlacklist,
    CreepyCavernHiddenBlockBlacklist,
    WaluigisIslandHiddenBlockBlacklist
};
...
void SetStarSpace(s32 starSpaceIndex) {
    s16 starSpaceID = HiddenBlockSpacesBlacklist[gGameStatus.boardIndex][starSpaceIndex];
...
void ResetStarSpaces(void) {
    ...
    for (int i = 0; i < CurBoardHiddenBlockBlacklistCount; i++) {
        s16 starSpaceID = HiddenBlockSpacesBlacklist[gGameStatus.boardIndex][i];
...
s16 func_800EB5DC_FF1FC(s32 arg0, u8 arg1, s32 numOfBoardSpaces) {
    ...
    var_s1 -= CurBoardHiddenBlockBlacklistCount;
    if (arg1 < 5) {
        var_s1 -= D_801054B6;
    }
    ...
    for (i = 0;; i = (++i < numOfBoardSpaces) ? i : 0) {
        temp_a1 = GetSpaceData(i);
        for (j = 0; j < CurBoardHiddenBlockBlacklistCount; j++) {
            if (HiddenBlockSpacesBlacklist[gGameStatus.boardIndex][j] == i) {
                break;
            }
        }
        if (j == CurBoardHiddenBlockBlacklistCount) {
            if (arg1 < 5) {
...
//func_800FC594_1101B4, on jp func_800F0DE4
